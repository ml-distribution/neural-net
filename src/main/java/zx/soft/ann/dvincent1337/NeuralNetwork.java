...
public class NeuralNetwork implements Serializable {
	 ...
	 */
	public void trainBP(DoubleMatrix inputs, DoubleMatrix outputs, double lambda, int max_iter, boolean verbose) {
		this.setTheta(NeuralNetwork.trainWithBackprop(inputs, outputs, this.getTheta(), this.getTopology(), lambda,
				max_iter, verbose));
	...
	public static DoubleMatrix forwardPropPredict(Vector<DoubleMatrix> Theta, DoubleMatrix X) {
		...
		for (int i = 1; i < Theta.size(); i++) {
			...
			a = DoubleMatrix.concatHorizontally(DoubleMatrix.ones(m, 1),
					sigmoid(activations.get(i - 1).mmul(Theta.get(i - 1).transpose())));
			activations.add(a);
		}
	 ...
	 */
	public static DoubleMatrix fmincg(CostFunction f, DoubleMatrix pInput, int max_iter, boolean verbose) {
		/*
	 ...
	 */
	public static Vector<DoubleMatrix> trainWithBackprop(DoubleMatrix X, DoubleMatrix Y, Vector<DoubleMatrix> Theta,
			int[] topology, double lambda, int max_iter, boolean verbose) {
