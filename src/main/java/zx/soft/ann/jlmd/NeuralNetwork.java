...
import zx.soft.ann.jlmd.exception.NotSameInputOutputSizeException;
import zx.soft.ann.jlmd.exception.ZeroInputDimensionException;
import zx.soft.ann.jlmd.exception.ZeroInputElementsException;
import zx.soft.ann.jlmd.exception.ZeroNeuronsException;
import zx.soft.ann.jlmd.parser.result.BinaryResultParser;
import zx.soft.ann.jlmd.parser.result.IResultParser;
import zx.soft.ann.jlmd.transfer.ITransferFunction;
import zx.soft.ann.jlmd.transfer.SigmoidFunction;
